...
export const getStorageValue = (storageStr) => {
  ...
  // Bắt số (nguyên hoặc thập phân) và tuỳ chọn bắt đơn vị (tb hoặc gb)
  ...
  // Nếu chỉ có số (vd: "256", "1"), tự suy luận:
  // Ổ cứng laptop thường >= 64GB, nếu số nhỏ hơn 10 thì chắc chắn là TB (vd 1, 2)
